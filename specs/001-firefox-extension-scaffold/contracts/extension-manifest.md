...
- `name` equals `Copy Structured Data`.
...
- The manifest declares no `permissions`, `host_permissions`, `optional_permissions`, content scripts, externally connectable origins, native messaging, or remote code.
